    ...
    try {
        ...
        for await (const i of images) {
            if (i.type === 'file') {
                ...
                (0, promises_1.pipeline)(i.file, node_fs_1.default.createWriteStream(`${imagesFolder}/products/${products[0].name}/${products[0].code || products[0].color}-${sequence}.${type[type.length - 1].toLowerCase()}`));
                imgs.push({
                    sequence,
